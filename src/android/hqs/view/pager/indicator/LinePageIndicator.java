 ...
 */
package android.hqs.view.pager.indicator;
...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    private int measureWidth(int measureSpec) {
        ...
        /*
         * 因为support library 23.1.1之后，FloatMath这个类的一些方法被去掉了，比如ceil()，
         * 所以，我们只要把使用到FloatMath.ceil()方法的这个地方给替换为Math.ceil(result)即可。
         */
