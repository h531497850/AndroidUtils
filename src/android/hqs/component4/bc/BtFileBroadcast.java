 ...
 * @author 胡青松
 */
public abstract class BtFileBroadcast extends BaseBroadcast {
	...
	public void register(Context context) {
		...
		ift.addAction(MTK_BLUETOOTH_START_ACTION);
		ift.addAction(QCOM_BLUETOOTH_START_ACTION);
		ift.addAction(QCOM_BLUETOOTH_END_ACTION);
