...
//	private static final int MINIMUM_CAPACITY = 4;
	...
	// 删除“键值对”
	final HashMapEntry<K, V> removeMapping(Object o) {
	...
	/**
	 * Entry是单向链表。 它是 “HashMap链式存储法”对应的链表。 它实现了Map.Entry 接口，即实现getKey(),
	 * getValue(), setValue(V value), equals(Object o), hashCode()这些函数
	 * 
	 * @author hqs2063594
	 * 
	 * @param <K>
	...
	static class HashMapEntry<K, V> implements Map.Entry<K, V> {
		...
		public String toString() {
			return "HashMapEntry [key=" + key + ", value=" + value + ", hash="
					+ hash + ", next=" + next + "]";
		}
	...
	void addEntry(int hash, K key, V value, int bucketIndex) {
		...
		// 设置“e”为“新Entry的下一个节点”
		table[bucketIndex] = new HashMapEntry<K, V>(key, value, hash, e);
	...
	private abstract class HashIterator<E> implements Iterator<E> {
		...
		// 获取下一个元素
		@SuppressWarnings("rawtypes")
		final HashMapEntry<K, V> nextEntry() {
	...
	private final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
		...
		public boolean contains(Object o) {
			...
			HashMapEntry<K, V> candidate = getEntry(e.getKey());
	...
	private void readObject(java.io.ObjectInputStream s) throws IOException,
		...
		table = new HashMapEntry[numBuckets];
