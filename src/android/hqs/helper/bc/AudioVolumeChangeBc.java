...
public abstract class AudioVolumeChangeBc extends DynamicBroadcast{
	...
	protected final String VOLUME_CHANGED_ACTION = "android.media.VOLUME_CHANGED_ACTION";
	protected final String EXTRA_VOLUME_STREAM_TYPE = "android.media.EXTRA_VOLUME_STREAM_TYPE";
	protected final String EXTRA_VOLUME_STREAM_VALUE = "android.media.EXTRA_VOLUME_STREAM_VALUE";
