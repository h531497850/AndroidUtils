...
public abstract class BtFileBc extends DynamicBroadcast {
	...
	protected final String MTK_BLUETOOTH_START_ACTION = "android.bluetooth.profilemanager.action.STATE_CHANGED";
	protected final String QCOM_BLUETOOTH_START_ACTION = "android.btopp.intent.action.VIVO_FILE_TRANSFER_START";
	protected final String QCOM_BLUETOOTH_END_ACTION = "android.btopp.intent.action.VIVO_FILE_TRANSFER_STOP";
