...
public abstract class GPSBc extends DynamicBroadcast{
	...
	protected final String EXTRA_GPS_ENABLED = "enabled";
	protected final String GPS_ENABLED_CHANGE_ACTION = "android.location.GPS_ENABLED_CHANGE";
	protected final String GPS_FIX_CHANGE = "android.location.GPS_FIX_CHANGE";
