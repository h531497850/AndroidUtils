...
/**
 * @ClassName LocalNitificationManager
 * @Description
 * @author 胡青松
 ...
 */
public class NitificationControler {
	...
	private static NitificationControler mLocalNitificationManager = null;
	 ...
	 */
	public synchronized static NitificationControler getInstance(final Context context) {
		if (mLocalNitificationManager == null) {
			mLocalNitificationManager = new NitificationControler(context);
		}
	 ...
	 * @param context
	 */
	private NitificationControler(final Context context) {
